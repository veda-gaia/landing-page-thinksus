...
export class EServiceComponent {
  ...
  questionaryData = [
    {
      question: 'Existe controle da pegada de carbono e ações para mitigação?',
      description: 'Pegada de carbono são quanto de matéria prima e produção de poluentes são criados durante o processo produtivo. Cálculos envolvem cada recurso natural consumido (como litros de gasolina, kgw de energia, quantidade de matéria prima, etc.). O cálculo quantifica por quantidade de carbono toda a operação, gerando uma pegada de carbono para ser reportada ao final',
      documentNeeded: true,
      id: 'E3'
    },
    {
    ...
    {
      question: 'O seu produto final possui uma embalagem descartável?',
      description: 'Embalagens descartáveis são feitas de materiais recicláveis, que podem ser reutilizadas e/ou reaproveitadas, diminuindo impactos negativos no meio ambiente',
      documentNeeded: true,
      id: 'E13'
    },
    {
