...
@Component({
  ...
  templateUrl: './s-industry.component.html',
  styleUrls: ['./s-industry.component.scss']
})
export class SIndustryComponent {
  actualStep = 1
  undefinedAnswers = 0
  keepReading = false
  ...
  questionaryData = [
    ...
    {
      question: 'Todos os Trabalhadores estão registrados, com benefícios sociais recolhidos corretamente mensalmente, com salário condizente com a função?',
      description: 'A empresa segue a CLT para contratação de funcionários, recolhe INSS e FGTS regularmente (sem atraso), com salários compatíveis com o mercado, respeitando ao menos o mínimo estabelicido pela convenção coletiva da categoria.',
      documentNeeded: true,
      id: 'S2'
    },
    {
